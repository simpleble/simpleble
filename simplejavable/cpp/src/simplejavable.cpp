...
Java_org_simplejavable_Adapter_nativeAdapterRegister(JNIEnv *env, jobject thiz, jlong adapter_id, jobject callback) {
...
Java_org_simplejavable_Peripheral_nativePeripheralServices(JNIEnv* env, jobject thiz,
    ...
    jclass serviceClass = env->FindClass("org/simplejnible/Service");
    jclass characteristicClass = env->FindClass("org/simplejnible/Characteristic");
    jclass descriptorClass = env->FindClass("org/simplejnible/Descriptor");
...
extern "C"
JNIEXPORT jobject JNICALL
Java_org_simplejavable_Peripheral_nativePeripheralManufacturerData(JNIEnv* env, jobject thiz, jlong adapter_id, jlong instance_id) {
    auto& peripheral = cached_peripherals[adapter_id].at(instance_id);
