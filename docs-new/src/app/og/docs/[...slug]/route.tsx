...
export async function GET(
  ...
  // The slug in params for /og/docs/[...slug] will be something like ["simpleble", "tutorial", "image.png"]
  // We need to remove "image.png" to get the page slug
  ...
  // In ImageResponse, we need an absolute URL for images.
