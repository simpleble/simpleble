...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/simplernble/`](android/src/main/java/com/margelo/nitro/simplernble/): All Kotlin implementations.
    - [`NitroSimplernblePackage.kt`](android/src/main/java/com/margelo/nitro/simplernble/NitroSimplernblePackage.kt): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.kt` file. In here, you can autolink all Kotlin HybridObjects.
