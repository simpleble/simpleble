...
1. **Native addon over SimpleCBLE.** The [C API](../simplecble/api) is a flat interface designed for FFI; wrapping the handful of calls your app uses with N-API is a bounded task.
