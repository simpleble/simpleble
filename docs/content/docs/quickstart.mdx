...
This quickstart gets you to the first adoption milestone: your application can see nearby BLE devices. After that, move to the [Connect](./recipes/connect) and [Read, Write, Notify](./recipes/read-write-notify) recipes, or [Advertise](./recipes/advertise) to host a local peripheral on Linux.
