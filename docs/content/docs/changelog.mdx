...
- (Linux) Fixed the new BlueZ backend to wait for locally-dispatched service resolution before reporting a peripheral as connected, preventing empty service lists on fresh connections.
