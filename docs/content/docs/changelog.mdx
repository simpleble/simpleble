...
- (SimpleSharpBLE) Added .NET 10 bindings and NuGet packaging for Windows x64 and ARM64.
- (SimpleSharpBLE) Added Apple Silicon macOS support.
- (SimpleSharpBLE) Added Linux x64 and ARM64 support.
