...
*Note: You must have installed the package first via `pip install "simplepyble[mcp]"`. If `simpleaible` is not in your system PATH, you may need to provide the full path to the executable.*
