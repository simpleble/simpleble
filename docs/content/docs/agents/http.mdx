---
title: HTTP Server
description: Comprehensive documentation for the SimplePyBLE HTTP server API.
---

SimplePyBLE includes a built-in HTTP server that allows you to control BLE devices using a REST API. This is particularly useful for controlling BLE devices remotely or for providing an interface for AI agents.
