...
SimpleBLE's `LICENSE.md` includes a Non-Commercial Perpetual Use Grant. After the Change Date, qualifying non-commercial users may continue using and distributing that version under the original BUSL-1.1 terms, notwithstanding its automatic conversion to GPL-3.0.
...
After four years of the initial release of a given version of SimpleBLE, the license automatically converts to the GNU General Public License version 3. Qualifying non-commercial users may instead continue using and distributing that version under the original BUSL-1.1 terms under the Non-Commercial Perpetual Use Grant.
