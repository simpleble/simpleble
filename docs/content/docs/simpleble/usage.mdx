...
includeBuild("path/to/simpleble/simpledroidbridge") {
    dependencySubstitution {
        substitute module("org.simpleble.android.bridge:simpledroidbridge") with project(":")
    }
}
```
...
For prebuilt release artifacts, download `libsimpleble_android_plugins.zip` from the [releases page](https://github.com/simpleble/simpleble/releases/latest), extract `simpledroidbridge-release.aar`, and add it to your Android app's Gradle dependencies.
