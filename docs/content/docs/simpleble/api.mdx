...
<ApiMethod
  ...
  notes={[
    {
      content: "Available on all supported platforms. Native Android callers must provide an application context with `SimpleBLE::Advanced::Android::set_context()` first.",
      type: "warn"
    }
  ]}
/>
