...
- [Installation](../installation) if you need to set up another language binding
- [Quickstart](../quickstart) for compact first-scan examples across C++, C, Python, Java, Rust, and Android
