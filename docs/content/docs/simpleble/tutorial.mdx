...
Hosting a local peripheral is currently implemented on Linux. On other platforms, `create_local_peripheral()` throws `SimpleBLE::Exception::OperationNotSupported`.
</Callout>
