...
| [SimpleDroidBLE](./simpledroidble/usage) | Kotlin / Android | Beta | Android-only applications | Gradle composite build or release AARs |
...
SimpleDroidBLE can be consumed from release AARs or as a Gradle composite build from a local checkout.
