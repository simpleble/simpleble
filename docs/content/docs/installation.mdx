...
| [SimpleJavaBLE](./simplejavable/usage) | Java | Early Preview | JVM desktop apps and prototypes | Gradle from source |
| [SimpleRsBLE](./simplersble/usage) | Rust | Early Preview | Rust applications and async workflows | crates.io or local path |
