...
TEST(UsbHelperWindowsTest, MatchesDonglHardwareIdsCaseInsensitively) {
...
TEST(UsbHelperWindowsTest, FormatsAllValidComPortNumbers) {
...
TEST(UsbHelperWindowsTest, RejectsInvalidComPortNames) {
