...
basic_DfuStartRsp Protocol::basic_dfu_start(uint32_t expected_version, uint32_t total_length) {
    fmt::print("Protocol::basic_dfu_start: expected_version={}, total_length={}\n", expected_version, total_length);
    dongl_Command command = dongl_Command_init_zero;
    command.which_cmd = dongl_Command_basic_tag;
...
basic_DfuChunkRsp Protocol::basic_dfu_chunk(uint32_t page_index, uint32_t offset_in_page, const std::vector<uint8_t>& encrypted_data) {
    dongl_Command command = dongl_Command_init_zero;
    command.which_cmd = dongl_Command_basic_tag;
...
basic_DfuRebootRsp Protocol::basic_dfu_reboot() {
    dongl_Command command = dongl_Command_init_zero;
    command.which_cmd = dongl_Command_basic_tag;
